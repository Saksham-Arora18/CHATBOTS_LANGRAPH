...
from complete_chatbot_backend import chatbot, retrieve_all_threads,save_thread_name,retrieve_thread_names
...
if user_input:
    ...
    if tid_str not in st.session_state['thread_names']:               # NEW
        st.session_state['thread_names'][tid_str] = get_chat_name(user_input)
